...
import { UserCircle, LogIn, ArrowRight, DoorOpen, LogOut, Loader2 } from "lucide-react";
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center p-4">
        <div className="text-center mb-12 space-y-4">
          ...
          <p className="text-lg md:text-xl text-emerald-100 max-w-2xl mx-auto font-light">
            Visitor Terminal for <span className="font-bold border-b-2 border-emerald-50">New Era INC Library</span>.
          </p>
        </div>
        ...
        <div className="flex justify-center w-full max-w-xl animate-in fade-in slide-in-from-bottom-4 duration-700">
          <Card className="border-none shadow-2xl hover:translate-y-[-8px] transition-all duration-300 bg-white/95 backdrop-blur-xl rounded-3xl group overflow-hidden w-full">
            ...
            <CardHeader className="text-center pb-2 pt-10">
              <div className="mx-auto bg-emerald-50 p-6 rounded-3xl w-fit mb-6 shadow-inner border border-emerald-100">
        ...
        <DialogContent className="sm:max-w-[440px] rounded-3xl border-none shadow-2xl p-0 overflow-hidden">
          ...
          <div className="p-10 bg-white space-y-6">
            <Button
              ...
              className="w-full h-16 bg-white border-2 border-emerald-100 text-emerald-900 hover:bg-emerald-50 rounded-2xl shadow-sm flex items-center justify-center gap-3 transition-all hover:border-emerald-300"
            >
              {isLoggingIn ? (
            ...
            <div className="flex flex-col items-center gap-2 pt-4 border-t border-emerald-50">
              <p className="text-[10px] text-center text-emerald-800/40 font-mono uppercase tracking-[0.2em]">
                Secure Institutional Access
              </p>
              <p className="text-[9px] text-center text-muted-foreground/60 max-w-[200px]">
                Access restricted to pre-authorized library administrators.
              </p>
            </div>
          </div>
        </DialogContent>
